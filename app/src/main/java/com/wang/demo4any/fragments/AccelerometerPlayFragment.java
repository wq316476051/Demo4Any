...
public class AccelerometerPlayFragment extends Fragment {

    private static final String TAG = "AccelerometerPlayFragment";

    public static final String TITLE = "Accelerometer";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSensorManager = getActivity().getSystemService(SensorManager.class);

        // Get an instance of the PowerManager
        mPowerManager = getActivity().getSystemService(PowerManager.class);

        // Get an instance of the WindowManager
        mWindowManager = getActivity().getSystemService(WindowManager.class);
...
//        setContentView(mSimulationView);
    ...
    public static Fragment newInstance() {
        return new AccelerometerPlayFragment();
    }
