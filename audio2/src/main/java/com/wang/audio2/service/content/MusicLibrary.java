package com.wang.audio2.service.content;
...
import com.wang.audio2.BuildConfig;
...
public class MusicLibrary {
    ...
    static {
        createMediaMetadataCompat("Jazz_In_Paris",
                "Jazz in Paris",
    ...
    public static List<MediaBrowserCompat.MediaItem> getMediaItems() {
        Log.e(TAG, "getMediaItems: ");
        List<MediaBrowserCompat.MediaItem> result = new ArrayList<>();
        for (MediaMetadataCompat mediaMetadata : MUSIC.values()) {
            result.add(new MediaBrowserCompat.MediaItem(mediaMetadata.getDescription(), MediaBrowserCompat.MediaItem.FLAG_PLAYABLE));
        }
        return result;
    }
